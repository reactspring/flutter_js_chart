...
class CanvasWrapper {
  ...
  /***** 삼각형타입 / 2023-06-29 ~ 작업 중 / Sangwon Kim *****/
  /// Directly calls [Canvas.drawVertices]
  void drawVertice(Offset center, double radius, Paint paint) {
    ...
    positions = [
      ...
      Offset(center.dx - radius * 1.2, center.dy + radius * 0.8),
      Offset(center.dx + radius * 1.2, center.dy + radius * 0.8),
    ];
    // print("center.dx: ${center.dx}, center.dy: ${center.dy}");
    mode = VertexMode.triangles;
    vertices = Vertices(mode, positions);
    blendMode = BlendMode.clear;
    return canvas.drawVertices(vertices, blendMode, paint);
  }
  // ----------------------------------------------------------- //
